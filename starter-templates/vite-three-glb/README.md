...
The smoke script is `node ../_shared/smoke-render.mjs --url http://localhost:4173 --canvas '#libcascade-canvas' --screenshot smoke.png`. CI uploads the screenshot artifact on failure.
