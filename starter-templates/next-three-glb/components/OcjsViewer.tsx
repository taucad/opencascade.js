...
import { getOcjs } from '../lib/ocjs-init';
...
export function OcjsViewer(): React.ReactElement {
  ...
  return (
    ...
    >
      ...
      >
        <strong>opencascade.js + three.js</strong>{' '}
        <span style={{ fontSize: '0.85rem', opacity: 0.7 }}>{status}</span>
      </header>
      <div id="ocjs-canvas" style={{ width: '100%', height: '100%' }}>
        <Canvas
