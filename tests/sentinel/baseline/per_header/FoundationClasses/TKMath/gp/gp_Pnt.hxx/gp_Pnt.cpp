...
using NCollection_Sequence_int = NCollection_Sequence<int>;struct gp_Pnt_Coord_Result {
  double theXp;
  double theYp;
  double theZp;
};

EMSCRIPTEN_BINDINGS(gp_Pnt) {
  value_object<gp_Pnt_Coord_Result>("gp_Pnt_Coord_Result")
    .field("theXp", &gp_Pnt_Coord_Result::theXp)
    .field("theYp", &gp_Pnt_Coord_Result::theYp)
    .field("theZp", &gp_Pnt_Coord_Result::theZp)
  ;
  class_<gp_Pnt>("gp_Pnt")
    .constructor<>()
    .constructor<const gp_XYZ &>()
    .constructor<const double, const double, const double>()
    .function("SetCoord", select_overload<void(const int, const double), gp_Pnt>(&gp_Pnt::SetCoord), allow_raw_pointers())
    .function("SetCoord", select_overload<void(const double, const double, const double), gp_Pnt>(&gp_Pnt::SetCoord), allow_raw_pointers())
    .function("SetX", &gp_Pnt::SetX, allow_raw_pointers())
    .function("SetY", &gp_Pnt::SetY, allow_raw_pointers())
    .function("SetZ", &gp_Pnt::SetZ, allow_raw_pointers())
    ...
    .function("Y", &gp_Pnt::Y, allow_raw_pointers())
    .function("Z", &gp_Pnt::Z, allow_raw_pointers())
    .function("XYZ", &gp_Pnt::XYZ, allow_raw_pointers())
    .function("ChangeCoord", &gp_Pnt::ChangeCoord, allow_raw_pointers())
    .function("BaryCenter", &gp_Pnt::BaryCenter, allow_raw_pointers())
    .function("IsEqual", &gp_Pnt::IsEqual, allow_raw_pointers())
    .function("Distance", &gp_Pnt::Distance, allow_raw_pointers())
    .function("SquareDistance", &gp_Pnt::SquareDistance, allow_raw_pointers())
    .function("Mirror", optional_override([](gp_Pnt& self, emscripten::val arg0) {
      if (arg0.typeOf().as<std::string>() == "object" && !emscripten::val::module_property("gp_Pnt").isUndefined() && arg0.instanceof(emscripten::val::module_property("gp_Pnt"))) {
        self.Mirror(arg0.as<const gp_Pnt &>(emscripten::allow_raw_pointers()));
        return;
      }
      else if (arg0.typeOf().as<std::string>() == "object" && !emscripten::val::module_property("gp_Ax1").isUndefined() && arg0.instanceof(emscripten::val::module_property("gp_Ax1"))) {
        self.Mirror(arg0.as<const gp_Ax1 &>(emscripten::allow_raw_pointers()));
        return;
      }
      else {
        self.Mirror(arg0.as<const gp_Ax2 &>(emscripten::allow_raw_pointers()));
        return;
      }
    }), allow_raw_pointers())
    .function("Mirrored", optional_override([](gp_Pnt& self, emscripten::val arg0) {
      if (arg0.typeOf().as<std::string>() == "object" && !emscripten::val::module_property("gp_Pnt").isUndefined() && arg0.instanceof(emscripten::val::module_property("gp_Pnt"))) {
        return self.Mirrored(arg0.as<const gp_Pnt &>(emscripten::allow_raw_pointers()));
      }
      else if (arg0.typeOf().as<std::string>() == "object" && !emscripten::val::module_property("gp_Ax1").isUndefined() && arg0.instanceof(emscripten::val::module_property("gp_Ax1"))) {
        return self.Mirrored(arg0.as<const gp_Ax1 &>(emscripten::allow_raw_pointers()));
      }
      else {
        return self.Mirrored(arg0.as<const gp_Ax2 &>(emscripten::allow_raw_pointers()));
      }
    }), allow_raw_pointers())
    .function("Rotate", &gp_Pnt::Rotate, allow_raw_pointers())
    .function("Rotated", &gp_Pnt::Rotated, allow_raw_pointers())
    .function("Scale", &gp_Pnt::Scale, allow_raw_pointers())
    .function("Scaled", &gp_Pnt::Scaled, allow_raw_pointers())
    .function("Transform", &gp_Pnt::Transform, allow_raw_pointers())
    .function("Transformed", &gp_Pnt::Transformed, allow_raw_pointers())
    .function("Translate", select_overload<void(const gp_Vec &), gp_Pnt>(&gp_Pnt::Translate), allow_raw_pointers())
    .function("Translate", select_overload<void(const gp_Pnt &, const gp_Pnt &), gp_Pnt>(&gp_Pnt::Translate), allow_raw_pointers())
    .function("Translated", select_overload<gp_Pnt(const gp_Vec &)const, gp_Pnt>(&gp_Pnt::Translated), allow_raw_pointers())
    .function("Translated", select_overload<gp_Pnt(const gp_Pnt &, const gp_Pnt &)const, gp_Pnt>(&gp_Pnt::Translated), allow_raw_pointers())
  ;
}

namespace emscripten { namespace internal { template<> void raw_destructor<gp_Pnt>(gp_Pnt* ptr) { /* do nothing */ } } }
