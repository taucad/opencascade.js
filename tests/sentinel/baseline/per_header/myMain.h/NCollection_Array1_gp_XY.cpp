...
using math_VectorBase_int = math_VectorBase<int>;EMSCRIPTEN_BINDINGS(NCollection_Array1_gp_XY) {
  ...
  class_<NCollection_Array1_gp_XY>("NCollection_Array1_gp_XY")
    ...
    .constructor<const gp_XY &, const size_t, const bool>()
    ...
    .function("IsEmpty", &NCollection_Array1_gp_XY::IsEmpty, allow_raw_pointers())
    .function("Lower", &NCollection_Array1_gp_XY::Lower, allow_raw_pointers())
    .function("Upper", &NCollection_Array1_gp_XY::Upper, allow_raw_pointers())
    .function("Assign", &NCollection_Array1_gp_XY::Assign, allow_raw_pointers())
    .function("CopyValues", &NCollection_Array1_gp_XY::CopyValues, allow_raw_pointers())
    .function("First", &NCollection_Array1_gp_XY::First, allow_raw_pointers())
    .function("ChangeFirst", &NCollection_Array1_gp_XY::ChangeFirst, allow_raw_pointers())
    .function("Last", &NCollection_Array1_gp_XY::Last, allow_raw_pointers())
    .function("ChangeLast", &NCollection_Array1_gp_XY::ChangeLast, allow_raw_pointers())
    .function("Value", &NCollection_Array1_gp_XY::Value, allow_raw_pointers())
    .function("ChangeValue", &NCollection_Array1_gp_XY::ChangeValue, allow_raw_pointers())
    .function("At", &NCollection_Array1_gp_XY::At, allow_raw_pointers())
    .function("ChangeAt", &NCollection_Array1_gp_XY::ChangeAt, allow_raw_pointers())
    .function("SetValue", select_overload<void(const int, const gp_XY &), NCollection_Array1_gp_XY>(&NCollection_Array1_gp_XY::SetValue), allow_raw_pointers())
    .function("UpdateLowerBound", &NCollection_Array1_gp_XY::UpdateLowerBound, allow_raw_pointers())
    .function("UpdateUpperBound", &NCollection_Array1_gp_XY::UpdateUpperBound, allow_raw_pointers())
    .function("Resize", select_overload<void(const int, const int, const bool), NCollection_Array1_gp_XY>(&NCollection_Array1_gp_XY::Resize), allow_raw_pointers())
    .function("Resize", select_overload<void(const size_t, const bool), NCollection_Array1_gp_XY>(&NCollection_Array1_gp_XY::Resize), allow_raw_pointers())
    .function("IsDeletable", &NCollection_Array1_gp_XY::IsDeletable, allow_raw_pointers())
  ;
}

namespace emscripten { namespace internal { template<> void raw_destructor<NCollection_Array1_gp_XY>(NCollection_Array1_gp_XY* ptr) { /* do nothing */ } } }
