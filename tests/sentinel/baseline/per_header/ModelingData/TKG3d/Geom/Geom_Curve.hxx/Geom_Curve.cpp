...
using NCollection_Sequence_int = NCollection_Sequence<int>;EMSCRIPTEN_BINDINGS(Geom_Curve) {
  class_<Geom_Curve, base<Geom_Geometry>>("Geom_Curve")
    .smart_ptr<opencascade::handle<Geom_Curve>>("Handle_Geom_Curve")
    .function("Reverse", &Geom_Curve::Reverse, allow_raw_pointers())
    .function("ReversedParameter", &Geom_Curve::ReversedParameter, allow_raw_pointers())
    .function("TransformedParameter", &Geom_Curve::TransformedParameter, allow_raw_pointers())
    .function("ParametricTransformation", &Geom_Curve::ParametricTransformation, allow_raw_pointers())
    .function("Reversed", &Geom_Curve::Reversed, allow_raw_pointers())
    .function("FirstParameter", &Geom_Curve::FirstParameter, allow_raw_pointers())
    .function("LastParameter", &Geom_Curve::LastParameter, allow_raw_pointers())
    .function("IsClosed", &Geom_Curve::IsClosed, allow_raw_pointers())
    .function("IsPeriodic", &Geom_Curve::IsPeriodic, allow_raw_pointers())
    .function("Period", &Geom_Curve::Period, allow_raw_pointers())
    .function("Continuity", &Geom_Curve::Continuity, allow_raw_pointers())
    .function("IsCN", &Geom_Curve::IsCN, allow_raw_pointers())
    .function("EvalD0", &Geom_Curve::EvalD0, allow_raw_pointers())
    .function("EvalD1", &Geom_Curve::EvalD1, allow_raw_pointers())
    .function("EvalD2", &Geom_Curve::EvalD2, allow_raw_pointers())
    .function("EvalD3", &Geom_Curve::EvalD3, allow_raw_pointers())
    .function("EvalDN", &Geom_Curve::EvalDN, allow_raw_pointers())
    .function("D0",
      optional_override([](const Geom_Curve& self, const double U, ::emscripten::val P) -> void {
        self.D0(U, *P.as<gp_Pnt*>(emscripten::allow_raw_pointers()));
      }), allow_raw_pointers())
    .function("D1",
      optional_override([](const Geom_Curve& self, const double U, ::emscripten::val P, ::emscripten::val V1) -> void {
        self.D1(U, *P.as<gp_Pnt*>(emscripten::allow_raw_pointers()), *V1.as<gp_Vec*>(emscripten::allow_raw_pointers()));
      }), allow_raw_pointers())
    .function("D2",
      optional_override([](const Geom_Curve& self, const double U, ::emscripten::val P, ::emscripten::val V1, ::emscripten::val V2) -> void {
        self.D2(U, *P.as<gp_Pnt*>(emscripten::allow_raw_pointers()), *V1.as<gp_Vec*>(emscripten::allow_raw_pointers()), *V2.as<gp_Vec*>(emscripten::allow_raw_pointers()));
      }), allow_raw_pointers())
    .function("D3",
      optional_override([](const Geom_Curve& self, const double U, ::emscripten::val P, ::emscripten::val V1, ::emscripten::val V2, ::emscripten::val V3) -> void {
        self.D3(U, *P.as<gp_Pnt*>(emscripten::allow_raw_pointers()), *V1.as<gp_Vec*>(emscripten::allow_raw_pointers()), *V2.as<gp_Vec*>(emscripten::allow_raw_pointers()), *V3.as<gp_Vec*>(emscripten::allow_raw_pointers()));
      }), allow_raw_pointers())
    .function("DN", &Geom_Curve::DN, allow_raw_pointers())
    .function("Value", &Geom_Curve::Value, allow_raw_pointers())
    .class_function("get_type_name",
      ((std::string (*)())[]() -> std::string {
        auto ret = Geom_Curve::get_type_name();
        return ret == nullptr ? std::string() : std::string(ret);
      }
    ), allow_raw_pointers())
    .class_function("get_type_descriptor", &Geom_Curve::get_type_descriptor, allow_raw_pointers())
    .function("DynamicType", &Geom_Curve::DynamicType, allow_raw_pointers())
  ;
  value_object<Geom_Curve::ResD1>("Geom_Curve_ResD1")
    .field("Point", &Geom_Curve::ResD1::Point)
    .field("D1", &Geom_Curve::ResD1::D1)
  ;
  value_object<Geom_Curve::ResD2>("Geom_Curve_ResD2")
    .field("Point", &Geom_Curve::ResD2::Point)
    .field("D1", &Geom_Curve::ResD2::D1)
    .field("D2", &Geom_Curve::ResD2::D2)
  ;
  value_object<Geom_Curve::ResD3>("Geom_Curve_ResD3")
    .field("Point", &Geom_Curve::ResD3::Point)
    .field("D1", &Geom_Curve::ResD3::D1)
    .field("D2", &Geom_Curve::ResD3::D2)
    .field("D3", &Geom_Curve::ResD3::D3)
  ;
}
