...
using NCollection_Sequence_int = NCollection_Sequence<int>;EMSCRIPTEN_BINDINGS(TopAbs_Orientation) {
  enum_<TopAbs_Orientation>("TopAbs_Orientation", emscripten::enum_value_type::string)
