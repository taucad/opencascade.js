...
using NCollection_Sequence_int = NCollection_Sequence<int>;EMSCRIPTEN_BINDINGS(BRepGraphInc_BaseDef) {
  class_<BRepGraphInc::BaseDef>("BRepGraphInc_BaseDef")
    .constructor<>()
    .property("OwnGen", &BRepGraphInc::BaseDef::OwnGen)
    .property("SubtreeGen", &BRepGraphInc::BaseDef::SubtreeGen)
    .property("LastPropWave", &BRepGraphInc::BaseDef::LastPropWave)
    .property("IsRemoved", &BRepGraphInc::BaseDef::IsRemoved)
  ;
}
