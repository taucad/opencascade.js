...
using NCollection_Sequence_int = NCollection_Sequence<int>;EMSCRIPTEN_BINDINGS(BRepGraph_Builder) {
  class_<BRepGraph_Builder>("BRepGraph_Builder")
    ...
    .class_function("Add", optional_override([](emscripten::val arg0, emscripten::val arg1, emscripten::val arg2) {
      if (arg2.typeOf().as<std::string>() == "object" && !emscripten::val::module_property("BRepGraph_Builder_Options").isUndefined() && arg2.instanceof(emscripten::val::module_property("BRepGraph_Builder_Options"))) {
        ...
        return BRepGraph_Builder::Add(arg0.as<BRepGraph &>(emscripten::allow_raw_pointers()), arg1.as<const TopoDS_Shape &>(emscripten::allow_raw_pointers()), arg2.as<const BRepGraph_NodeId>(emscripten::allow_raw_pointers()));
      }
    }), allow_raw_pointers())
  ...
  ;
  value_object<BRepGraph_Builder::Options>("BRepGraph_Builder_Options")
    .field("Populate", &BRepGraph_Builder::Options::Populate)
    .field("CreateAutoProduct", &BRepGraph_Builder::Options::CreateAutoProduct)
    .field("Flatten", &BRepGraph_Builder::Options::Flatten)
    .field("Parallel", &BRepGraph_Builder::Options::Parallel)
  ;
...
namespace emscripten { namespace internal { template<> void raw_destructor<BRepGraph_Builder>(BRepGraph_Builder* ptr) { /* do nothing */ } } }
