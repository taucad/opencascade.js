...
using math_VectorBase_int = math_VectorBase<int>;EMSCRIPTEN_BINDINGS(BRepGraph_FacesOfEdge) {
  class_<BRepGraph_FacesOfEdge>("BRepGraph_FacesOfEdge")
    ...
    .function("More", &BRepGraph_FacesOfEdge::More, allow_raw_pointers())
    .function("Next", &BRepGraph_FacesOfEdge::Next, allow_raw_pointers())
    .function("CurrentId", &BRepGraph_FacesOfEdge::CurrentId, allow_raw_pointers())
    .function("Current", &BRepGraph_FacesOfEdge::Current, allow_raw_pointers())
    .function("Definition", &BRepGraph_FacesOfEdge::Definition, allow_raw_pointers())
    .function("Index", &BRepGraph_FacesOfEdge::Index, allow_raw_pointers())
    .function("Length", &BRepGraph_FacesOfEdge::Length, allow_raw_pointers())
    .function("Size", &BRepGraph_FacesOfEdge::Size, allow_raw_pointers())
    .function("Value", &BRepGraph_FacesOfEdge::Value, allow_raw_pointers())
    .function("end", &BRepGraph_FacesOfEdge::end, allow_raw_pointers())
  ;
}
