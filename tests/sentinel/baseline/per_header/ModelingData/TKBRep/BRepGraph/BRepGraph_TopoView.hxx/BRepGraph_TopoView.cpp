...
using NCollection_Sequence_int = NCollection_Sequence<int>;EMSCRIPTEN_BINDINGS(BRepGraph_TopoView) {
  class_<BRepGraph::TopoView>("BRepGraph_TopoView")
    .function("Faces", &BRepGraph::TopoView::Faces, allow_raw_pointers())
    .function("Edges", &BRepGraph::TopoView::Edges, allow_raw_pointers())
    .function("Vertices", &BRepGraph::TopoView::Vertices, allow_raw_pointers())
    .function("Wires", &BRepGraph::TopoView::Wires, allow_raw_pointers())
    .function("Shells", &BRepGraph::TopoView::Shells, allow_raw_pointers())
    .function("Solids", &BRepGraph::TopoView::Solids, allow_raw_pointers())
    .function("CoEdges", &BRepGraph::TopoView::CoEdges, allow_raw_pointers())
    .function("Compounds", &BRepGraph::TopoView::Compounds, allow_raw_pointers())
    .function("CompSolids", &BRepGraph::TopoView::CompSolids, allow_raw_pointers())
    .function("Products", &BRepGraph::TopoView::Products, allow_raw_pointers())
    .function("Occurrences", &BRepGraph::TopoView::Occurrences, allow_raw_pointers())
    .function("Gen", &BRepGraph::TopoView::Gen, allow_raw_pointers())
    .function("Geometry", &BRepGraph::TopoView::Geometry, allow_raw_pointers())
  ;
}
