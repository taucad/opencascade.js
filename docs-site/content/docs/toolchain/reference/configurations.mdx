...
- [Emscripten settings and flags](../guides/custom-emcc-flags) — link-time `settings` rationale.
- [Driver environment](./env-vars) — driver variables and the `OCJS_*` catalogue.
