...
| -------------------------- | ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| `single-threaded`          | Default OpenCascade.js build (`opencascade_full.*`). Browser default. | `OCJS_OPT=-O3`, `OCJS_WASM_OPT_LEVEL=-O4`, `THREADING=single-threaded`         |
...
| `multi-threaded`           | Published `cascadic/multi` build. SAB/COOP+COEP-isolated deployments.     | `OCJS_OPT=-O3`, `OCJS_WASM_OPT_LEVEL=-O4`, `THREADING=multi-threaded`          |
