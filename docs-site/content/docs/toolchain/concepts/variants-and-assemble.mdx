...
description: One bindings list, N binaries, one types.d.ts — the shared surface, createInstance, eager vs factory roots, and the exports fragment.
---
...
- [Config reference](../reference/config) — the `variants` and `assemble` fields.
