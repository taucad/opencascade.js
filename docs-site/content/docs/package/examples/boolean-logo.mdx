---
title: Boolean logo
description: Build the libcascade logo with boolean cuts and rotations against a sphere.
---
...
2. `makeCut` constructs a transform (translate + scale), wraps it in a
   ...
   `BRepAlgoAPI_Cut`.
3. Four sequential cuts produce one half of the libcascade logo glyph.
