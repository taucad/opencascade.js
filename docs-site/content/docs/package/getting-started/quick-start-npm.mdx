...
import { getOc } from './libcascade-init';
...
> **Want threading?** For batch meshing and boolean workloads, import `libcascade/multi` instead of the default export. Browser deployments require COOP/COEP headers — see the [Multi-threaded build guide](../guides/multi-threading) and [Bundler & locateFile — Multi-threaded variant](../guides/bundler-locatefile#multi-threaded-variant).
