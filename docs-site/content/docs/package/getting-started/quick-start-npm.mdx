...
description: Install cascadic, render a 60×40×20 box with a 3 mm fillet, and export GLB.
---
...
```bash
pnpm add cascadic@canary three
...
> **Want threading?** For batch meshing and boolean workloads, import `cascadic/multi` instead of the default export. Browser deployments require COOP/COEP headers — see the [Multi-threaded build guide](../guides/multi-threading) and [Bundler & locateFile — Multi-threaded variant](../guides/bundler-locatefile#multi-threaded-variant).
