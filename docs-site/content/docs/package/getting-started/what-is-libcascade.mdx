---
title: What is libcascade
description: One-page concept — what libcascade is, why it exists, and when to reach for it.
---

libcascade brings the OpenCASCADE Technology kernel — a 30-year-old
...
[`taucad/opencascade.js`](https://github.com/taucad/opencascade.js) and
published on npm as [`libcascade`](https://www.npmjs.com/package/libcascade). It
was originally created by Sebastian Alff (`donalffons`) and is not an official
Open CASCADE Technology distribution.
...
- You need sub-megabyte wasm — full OCCT is ~40 MB; even trimmed it sits at ~12 MB
...
- [Trim symbols](/docs/toolchain/guides/trim-symbols) — cut the wasm from 40 MB down to what your app uses.
