...
The libcascade bindings present OCCT to JavaScript through a handful of conventions
...
libcascade V3 removed the legacy `_N` overload suffixes. You always call the
