...
async function create_negative(moduleArg = {}) {
  var moduleRtn;
...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('negative.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('negative.wasm', import.meta.url).href;
...
// Begin JS library code
  ...
  var ensureOverloadSignatureTable = (proto, methodName, humanName, numArguments) => {
  ...
  /**
     ...
     */
  var exposePublicSymbol = (name, value, numArguments, rawSignature) => {
  ...
  /**
    ...
    @param {string=} rawSignature
     */
  var replacePublicSymbol = (name, value, numArguments, signatureArray, rawSignature) => {
      if (!Module.hasOwnProperty(name)) {
...
export default create_negative;
