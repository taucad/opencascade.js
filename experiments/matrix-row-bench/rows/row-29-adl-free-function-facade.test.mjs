// row-29 — ADL / free function / static helper — explicit class_function facade.
//
// Primitive: facade
// Test subject (real OCCT class): BRepTools
// Subject note: BRepTools.Read free function
...
await defineRow(29, async ({ mod, shape }) => {
  // Primitive 'facade' is exercised structurally (no live invocation
  ...
  return { result: { primitive: 'facade', structuralCheck: true } };
});
