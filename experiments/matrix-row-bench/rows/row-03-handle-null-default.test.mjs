// row-03 — Single overload, trailing handle default = Handle() (null).
//
// Primitive: optional
// Test subject (real OCCT class): BRepMesh_IncrementalMesh
// Subject note: optional<handle<NCollection_BaseAllocator>> at trailing position
...
await defineRow(3, async ({ mod, shape }) => {
