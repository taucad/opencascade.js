// GENERATED by packages/toolchain/scripts/generate-occt-symbols.mjs from dist/api-reference.json (ocjs-api-reference-v1, libcascade 3.0.0) + the toolchain image's build/ncollection-manifest.json typedef aliases and Embind builtin registrations — do not edit.
